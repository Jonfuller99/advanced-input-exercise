...
public class Knight 
{
    ...
    public void LoadContent(ContentManager content) 
    {
        ...
        _moveJump = new InputAction(new Buttons[] {Buttons.DPadUp}, new Keys[]{Keys.Up, Keys.Space}, false);
    }
    ...
    public void Update(GameTime gameTime) 
    {
        ...
        if(_moveJump.Occured(_inputState, null, out controllingPlayer ) && !_isJumping && !_isFalling) // TODO: Check for jump input 
        {
            _isJumping = true;
